                    ...
                    <div class="flex items-center">
                        ...
                        <div class="hidden md:block">
                            <div class="ml-10 flex items-baseline space-x-4">
                                ...
                                <x-nav href="/" aria-current="page" :active="request()->is('/')">Home</x-nav>
                                <x-nav href="/contact" :active="request()->is('contact')">Contact Us</x-nav>
                                <x-nav href="/about" :active="request()->is('about')">About Us</x-nav>
